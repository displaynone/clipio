...
export default function HomeEmptyState({ onLoadVideos, isLoading = false }: Props) {
          ...
          <MaskedView
            ...
            maskElement={
              <View className="items-center">
                <Text style={styles.maskText}>starts here</Text>
              </View>
            }
          >
            <LinearGradient
            ...
            >
              <Text style={styles.maskTextFiller}>starts here</Text>
            </LinearGradient>
          </MaskedView>
          <Text className="mt-5 max-w-[320px] text-center text-base leading-7 text-muted">
            No videos loaded yet. Start your cinematic journey by adding some clips.
          </Text>
        </View>

        <PressableFeedback onPress={onLoadVideos} className="xw-full max-w-[320px] overflow-hidden rounded-xl">
          <LinearGradient
            colors={[primary, primaryDim]}
            start={{ x: 0.1, y: 0 }}
            end={{ x: 1, y: 1 }}
